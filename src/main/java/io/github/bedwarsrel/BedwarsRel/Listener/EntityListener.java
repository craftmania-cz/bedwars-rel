...
public class EntityListener extends BaseListener {
  ...
  public void onEntitySpawn(CreatureSpawnEvent ese) {
    ...
    if (ese.getEntityType().equals(EntityType.CREEPER)
        ...
        || ese.getEntityType().equals(EntityType.CHICKEN)
              || ese.getEntityType().equals(EntityType.ENDER_DRAGON)
              || ese.getEntityType().equals(EntityType.ENDERMAN)
              || ese.getEntityType().equals(EntityType.ENDERMITE)) {
